...
const EventCreateModal: React.FC = () => {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Instead of useNavigate (which requires Router context),
      // do a simple redirect:
      window.location.href = `/events/${created.id}/manage`;
    } catch (err: any) {
      const msg =
