// src/components/EventAmigoConnectors/EventAmigoConnectorItem.tsx
  ...
  return (
    <div className="event-amigo-connector-item">
      ...
      <div className="amigo-details">
        ...
        {eventAmigoConnector.amigo.avatar_url && <img src={eventAmigoConnector.amigo.avatar_url} alt={`${eventAmigoConnector.amigo.first_name}'s avatar`} />}
      </div>
