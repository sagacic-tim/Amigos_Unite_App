...
export default function Profile() {
  ...
  const loadAll = useCallback(async () => {
    ...
    // ─── Core amigo info: name, emails, phones ───
    try {
    ...
    // ─── Amigo Location(s) ───
    try {
      const l = await privateApi.get(`/api/v1/amigos/${amigoId}/amigo_locations`, {
        withCredentials: true,
      });
  ...
  // Single save for core Amigo + Details + Location
  const saveAll = async () => {
    if (!amigoId) return;
    setSaving(true);
    setError(null);
    ...
    try {
      ...
      if (amigoCore) {
        ...
        // Let backend normalize whatever the user typed
        if (core.phone_1) {
        ...
        // Keep auth-layer currentUser + amigos list in sync
        await refreshAuth();
      }
      ...
      // Refresh UI data to show any server-calculated fields (e.g., normalized phones)
      await loadAll();
      setSaved(true);
    } catch (e: any) {
              ...
              <fieldset>
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoreChange('first_name', e.target.value)}
                  />
                </label>
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoreChange('last_name', e.target.value)}
                  />
                </label>
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoreChange('user_name', e.target.value)}
                  />
                </label>
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoreChange('secondary_email', e.target.value)}
                  />
                </label>
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoreChange('phone_1', e.target.value)}
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) => handleCoreChange('phone_2', e.target.value)}
                    placeholder="+1 (626) 998-2531"
                  />
                  <small className="form-hint">
                    Enter any format; we&apos;ll store it in international format.
              ...
              <fieldset>
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailsChange('date_of_birth', e.target.value || null)
                    }
                  />
                </label>
                ...
                <label className="checkbox">
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailsChange('member_in_good_standing', e.target.checked)
                    }
                  />
                ...
                <label className="checkbox">
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailsChange('available_to_host', e.target.checked)
                    }
                  />
                ...
                <label className="checkbox">
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailsChange('willing_to_help', e.target.checked)
                    }
                  />
                ...
                <label className="checkbox">
                  <input
                    ...
                    onChange={(e) =>
                      handleDetailsChange('willing_to_donate', e.target.checked)
                    }
                  />
                ...
                <label className="textarea">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handleDetailsChange('personal_bio', e.target.value || null)
                    }
                    rows={5}
                  />
                </label>
            ...
            <div className="form-grid">
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleLocationChange('apartment_suite_number', e.target.value)
                  }
                />
              </label>
              ...
              <fieldset>
                ...
                <label className="radio">
                  <input
                    ...
                    value="upload"
                    onChange={() =>
                      setDetails((d: any) => ({ ...d, avatar_source: 'upload' }))
                    }
                  />
                ...
                <label className="radio">
                  <input
                    ...
                    value="gravatar"
                    onChange={() =>
                      setDetails((d: any) => ({ ...d, avatar_source: 'gravatar' }))
                    }
                  />
                ...
                <label className="radio">
                  <input
                    ...
                    value="url"
                    onChange={() =>
                      setDetails((d: any) => ({ ...d, avatar_source: 'url' }))
                    }
                  />
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    setError(
                      e?.response?.data?.errors?.[0] ?? 'Failed to update avatar.'
                    );
                  } finally {
                    setSaving(false);
                  }
