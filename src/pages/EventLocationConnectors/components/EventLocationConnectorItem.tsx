  ...
  return (
    <div className="event-location-connector-item">
      ...
      <div className="location-details">
        ...
        <p>
          Address: {eventLocationConnector.business_address.street}, {eventLocationConnector.business_address.city},{' '}
          {eventLocationConnector.business_address.state}, {eventLocationConnector.business_address.postal_code},{' '}
          {eventLocationConnector.business_address.country}
        </p>
